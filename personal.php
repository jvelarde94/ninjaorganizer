...
include("connect.php"); //connect to database
 if(isset($_POST['edit']))
    ...
    {
      header('location:http://ninajaorganizer.com/update.php?id='.$id_goal.'&type=personal');
    }
    }
     }
?>
...
<h1 class="ui center aligned header">Personal Goals</h1>
<div class="ui container">
  ...
  <div class="ui relaxed divided items">
    <div class="item">
      ...
      <div class="content">
        ...
        <div class="meta">
          <form class="ui form" action="personal.php" method="post" accept-charset="utf-8">
  <div class="field">
    <label>Goal</label>
  ...
  <button class="ui button" type="submit" name="showGoals">Show My Personal Goals</button>
</form>
        </div>
      </div>
    </div>
